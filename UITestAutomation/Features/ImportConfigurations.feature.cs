...
#line hidden
                ...
                table22.AddRow(new string[] {
                            "Refresh"});
#line 12
 testRunner.And("User validates the following UI Controls on the Import Configurations Page", ((string)(null)), table22, "And ");
#line hidden
#line 18
 testRunner.And("User clicks the Add Configuration Icon on the Import Configurations Page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
                ...
                table23.AddRow(new string[] {
                            "Header in First Row"});
#line 19
 testRunner.And("User validates the following fields on the Import Configurations Page", ((string)(null)), table23, "And ");
#line hidden
#line 26
    testRunner.When("User clicks the save Button on the Import Configurations Page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 27
    testRunner.Then("User will be able to see the new information in the fields on the Import Configur" +
