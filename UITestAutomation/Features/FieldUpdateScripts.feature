...
Scenario: Field Update Scripts
	...
	| Operator         |
	| Value/Function   |
   When User clicks the save Button on the Field Update Script Page
   Then User will be able to see the new information in the fields on the Field Update Script Page
   And Close and Upload to library poochna he ??
